...
interface ShapeGridProps {
    ...
    /** Colore verso cui sfuma il bordo del canvas; `null` per non disegnare la vignettatura. */
...
const ShapeGrid: React.FC<ShapeGridProps> = ({
    ...
    useEffect(() => {
        ...
        // Il disegno lavora in pixel CSS (width/height); il backing store è moltiplicato
        // per il devicePixelRatio, altrimenti su retina le linee escono sgranate.
        let width = 0;
        let height = 0;
        const resizeCanvas = () => {
        ...
        // Con "riduci movimento" la griglia sta ferma: resta solo l'hover.
        ...
        // Il mouse si ascolta sulla finestra e non sul canvas: da sfondo, il canvas sta
        // sotto i contenuti e non riceverebbe gli eventi.
        ...
        // Il loop gira sul ticker di GSAP, come il resto delle animazioni dell'app.
        const tryStart = () => {
